...
module.exports = async function (deployer, network, accounts) {
  ...
  console.log("Estimating gas: " + await pazariMVP.createUserProfile.estimateGas(uri1, amount1, price1, {from: seller}))
  ...
  console.log("Estimating gas: " + await pazariMVP.newTokenListing.estimateGas(uri2, amount2, price2, {from: seller}))
  ...
  */
  ...
  console.log("Estimating gas: " + await pazariMVP.createUserProfile.estimateGas(uri1, amount1, price1, {from: seller2}));
  ...
  console.log("Estimating gas: " + await pazariMVP.newTokenListing.estimateGas(uri4, amount4, price4, {from: seller}));
