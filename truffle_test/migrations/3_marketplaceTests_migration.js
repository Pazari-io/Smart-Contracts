...
module.exports = async function (deployer, network, accounts) {
  ...
  // Item 1
  itemID = await market.createMarketItem.call(token.address, tokenID, sellAmount1, price, paymentContract, routeID, {
    from: seller,
  });
  console.log("Running createMarketItem() for itemID " + itemID + ":");
  console.log(
    "Estimating gas: " +
      (await market.createMarketItem.estimateGas(token.address, tokenID, sellAmount1, price, paymentContract, routeID, {
        from: seller,
      })),
  );
  await market.createMarketItem(token.address, tokenID, sellAmount1, price, paymentContract, routeID, { from: seller });
  console.log("createMarketItem() success");
  console.log("itemID " + itemID + " has " + (await token.balanceOf(market.address, tokenID)) + " units available");
  ...
  console.log(
    "Estimating gas: " +
      (await market.createMarketItem.estimateGas(
        tokenAddress2,
        tokenID2,
        sellAmount2,
        price2,
  ...
  await market.createMarketItem(tokenAddress2, tokenID2, sellAmount2, price2, paymentContract, routeID2, {
    from: seller2,
  });
  console.log("createMarketItem() success");
  console.log("itemID " + itemID2 + " has " + (await token.balanceOf(market.address, tokenID2)) + " units available");
  ...
  await market.createMarketItem(token3.address, tokenID3, sellAmount3, price3, paymentContract, routeID3, {
    from: seller3,
  });
  console.log("createMarketItem() success");
  console.log(
    "itemID " + (await itemID3) + " has " + (await token.balanceOf(market.address, tokenID3)) + " units available",
  );
...
*/
  ...
  console.log(
    "Seller1: $" + web3.utils.fromWei(await router.getPaymentBalance(seller, stablecoin.address, { from: seller })),
  );
  console.log(
    "Seller2: $" + web3.utils.fromWei(await router.getPaymentBalance(seller2, stablecoin.address, { from: seller2 })),
  );
  console.log(
    "Seller3: $" + web3.utils.fromWei(await router.getPaymentBalance(seller3, stablecoin.address, { from: seller3 })),
  );
...
*/
  ...
  console.log(
    "Estimating gas: " +
      (await market.modifyMarketItem.estimateGas(itemID, price, stablecoin.address, isPush, routeID, itemLimit1, {
        from: seller,
      })),
  );
  ...
  console.log(
    "Estimating gas: " +
      (await market.modifyMarketItem.estimateGas(itemID2, price2, stablecoin.address, isPush2, routeID2, itemLimit2, {
        from: seller2,
      })),
  );
  await market.modifyMarketItem(itemID2, price2, stablecoin.address, isPush2, routeID2, itemLimit2, { from: seller2 });
  ...
  console.log(
    "Estimating gas: " +
      (await market.modifyMarketItem.estimateGas(itemID3, price3, stablecoin.address, isPush3, routeID3, itemLimit3, {
        from: seller3,
      })),
  );
  await market.modifyMarketItem(itemID3, price3, stablecoin.address, isPush3, routeID3, itemLimit3, { from: seller3 });
