...
module.exports = async function (deployer, network, accounts) {
  ...
  console.log(
    ...
    + (await itemID) 
    + " has " 
    + (await pazariToken.balanceOf(market.address, tokenID)) 
    + " units available",
    );
  ...
  console.log(
    ...
    + itemID2 
    + " has " 
    + (await pazariToken.balanceOf(market.address, tokenID2)) 
    + " units available",
    );  
...
*/
  ...
  console.log("Checking if accounts[8] owns tokenID 2: " + await market.ownsToken(accounts[8], pazariToken.address, tokenID2));
  /*
   * To test:
