...
module.exports = async function (deployer, network, accounts) {
  ...
  */
  ...
  console.log(
    "\n Estimating gas for routeID 1: " +
      (await router.pushTokens.estimateGas(routeID, stablecoin.address, buyer, price, { from: devWallet })),
  );
  await router.pushTokens(routeID, stablecoin.address, buyer, price, { from: devWallet });
  console.log(
    "\n Estimating gas for routeID 2: " +
      (await router.pushTokens.estimateGas(routeID2, stablecoin.address, buyer, price, { from: devWallet })),
  );
  await router.pushTokens(routeID2, stablecoin.address, buyer, price, { from: devWallet });
  console.log(
    "\n Estimating gas for routeID 3: " +
      (await router.pushTokens.estimateGas(routeID3, stablecoin.address, buyer, price, { from: devWallet })),
  );
  ...
  console.log(
    "\n Estimating gas for seller: " +
      (await router.holdTokens.estimateGas(routeID, stablecoin.address, buyer, price, { from: devWallet })),
  );
  await router.holdTokens(routeID, stablecoin.address, buyer, price, { from: devWallet });
  console.log(
    "\n Estimating gas for seller2: " +
      (await router.holdTokens.estimateGas(routeID2, stablecoin.address, buyer, price, { from: devWallet })),
  );
  await router.holdTokens(routeID2, stablecoin.address, buyer, price, { from: devWallet });
  console.log(
    "\n Estimating gas for seller3: " +
      (await router.holdTokens.estimateGas(routeID3, stablecoin.address, buyer, price, { from: devWallet })),
  );
  ...
  console.log(
    "Seller3: $" + web3.utils.fromWei(await router.getPaymentBalance(buyer, stablecoin.address, { from: buyer })),
  );
  console.log("Buyer: $" + web3.utils.fromWei(await stablecoin.balanceOf(buyer)));
  console.log("Seller: $" + web3.utils.fromWei(await stablecoin.balanceOf(seller)));
  console.log("Seller2: $" + web3.utils.fromWei(await stablecoin.balanceOf(seller2)));
  ...
  console.log(
    "Estimating gas cost for routeID 1 (true => false): " +
      (await router.togglePaymentRoute.estimateGas(routeID, { from: devWallet })),
  );
  await router.togglePaymentRoute(routeID, { from: devWallet });
  console.log(
    "Estimating gas cost for routeID 1 (false => true): " +
      (await router.togglePaymentRoute.estimateGas(routeID, { from: devWallet })),
  );
  await router.togglePaymentRoute(routeID, { from: devWallet });
...
*/
  ...
  maxTax = 2500;
  console.log(
    "Estimating gas cost: " + (await router.adjustTaxBounds.estimateGas(minTax, maxTax, { from: devWallet })),
  );
  ...
  console.log(
    "Estimating gas cost: " +
      (await router.pushTokens.estimateGas(routeID2, stablecoin.address, buyer, price2, { from: devWallet })),
  );
  await router.pushTokens(routeID2, stablecoin.address, buyer, price2, { from: devWallet });
  console.log(
    "Estimating gas cost: " +
      (await router.pushTokens.estimateGas(routeID3, stablecoin.address, buyer, price3, { from: devWallet })),
  );
  ...
  await router.setTreasuryAddress(treasury, "Hello World");
  console.log("Current treasury address: " + (await router.pazariTreasury()));
